...
if (!params.skipAlignment) {
  ...
  process featureCounts {
      ...
      """
      featureCounts -a $gtf -g ${params.fc_group_features} -t ${params.fc_count_type} -o ${bam_featurecounts.baseName}_gene.featureCounts.txt $extraAttributes $featureCounts_paired -s $featureCounts_direction $bam_featurecounts
      $biotype_qc
      $mod_biotype
      """
  }
